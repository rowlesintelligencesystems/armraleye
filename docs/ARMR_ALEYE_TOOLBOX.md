...
| Termux (founder device) | Mobile Worker / secret ops when laptop unavailable |
...
### 4.5 Milestone gate — definition of done
...
### 4.6 Milestone gate — accept note
...
### 4.8 Navy-plate composite (Python sketch)
...
- Side quests (new engines, new research) during a “finish the manual” ask  
...
1. Seek God within — pause before push; serve real inventory need  
